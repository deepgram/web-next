...
<div class="screenshot">
	<img src="./integrate-zoom_join-computer-audio.png" alt="Join Zoom with Computer Audio" />
</div>

2. Select **More…** and then **Live on Custom Live Streaming Service**.

<div class="screenshot">
	<img src="./integrate-zoom_more-livestream.png" alt="Zoom More menu" />
</div>

3. Configure streaming, and select **Go Live!**.

   <div class="screenshot">
   	<img src="./integrate-zoom_configure-livestream.png" alt="Configure Zoom Livestreaming" />
   </div>
