...
[event emitter](https://nodejs.dev/learn/the-nodejs-event-emitter). Events
...
[event emitter](https://nodejs.dev/learn/the-nodejs-event-emitter) that your
...
The `getReadyState` function returns the ready state of the websocket connection
to Deepgram.
