...
<Callout title="NOTEBOOK">
    ...
    <a href="/notebooks/QuickStart_Deepgram_Pre_Recorded_Audio_Notebook.ipynb" class="flex items-center py-1 mt-2" download="prerecorded.ipynb">
    	<Icon class="mr-2" icon="cloud-download" />
    	Pre-recorded audio notebook
    </a>

    <a href="/notebooks/QuickStart_Deepgram_Live_Audio_Streaming_Notebook.ipynb" class="flex items-center py-1" download="quickstart.ipynb">
    	<Icon class="mr-2" icon="cloud-download" />
