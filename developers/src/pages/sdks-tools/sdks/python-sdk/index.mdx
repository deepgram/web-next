...
<Callout title="NOTEBOOK">
	Prefer the workflow of a Python notebook? Download our Python starter notebook and get started quickly without having to copy or paste any code.

    <a href="../../../../assets/notebooks/QuickStart_Deepgram_Pre_Recorded_Audio_Notebook.ipynb" class="flex items-center py-1 mt-2">
    	<Icon class="mr-2" icon="cloud-download" />
    	Pre-recorded audio notebook
    </a>

    <a href="../../../../assets/notebooks/QuickStart_Deepgram_Live_Audio_Streaming_Notebook.ipynb" class="flex items-center py-1">
    	<Icon class="mr-2" icon="cloud-download" />
