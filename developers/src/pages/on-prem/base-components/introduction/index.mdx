...
title: Introduction
description: Learn about on-premises deployments of Deepgram products using AutoML-trained models.
order: 1
seo:
  metaTitle: Introduction
  metaDescription: Learn about on-premises deployments of Deepgram products using AutoML-trained models.
...
## What is AutoML
AutoML is a collection of tools and services which are used to produce trained AI models for the purpose automatic speech recognition (ASR). From an on-prem perspective, there is a solution called AutoML which enables users to customize Deepgram's ASR models with their own data.
