...
description: If you're looking to get started with Deepgram's audio streaming capabilities, our streaming test suite is the perfect place to begin. The test suite provides sample code that allows you to easily stream basic audio to Deepgram, ensuring that you have the necessary foundation to build for your unique use case.
type: "tips"
order: 3
seo:
  metaTitle: "Getting Started With the Streaming Test Suite"
  metaDescription: If you're looking to get started with Deepgram's audio streaming capabilities, our streaming test suite is the perfect place to begin. The test suite provides sample code that allows you to easily stream basic audio to Deepgram, ensuring that you have the necessary foundation to build for your unique use case.
...
<Image src={import("./intro.png")} alt="image of terminal showing the streaming test suite transcribing the Preamble" />
...
<Alert type="info">Make sure to replace `YOUR_DEEPGRAM_API_KEY` with an API key generated from our [Console](https://console.deepgram.com/).</Alert>
...
<Image src={import("./server_messages_1.png")} alt="image of terminal showing message that websocket has opened" />
...
<Image src={import("./server_messages_2.png")} alt="image of terminal showing message that websocket is receiving data" />
...
<Image src={import("./test_dg_1.png")} alt="image of terminal showing lines to edit to connect to Deepgram" />

Don't forget add your DG API key to the websocket headers where it says `YOUR_DG_API_KEY`.

<Image src={import("./test_dg_2.png")} alt="image of terminal showing where to add Deepgram API key" />
