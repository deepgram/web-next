...
This article covers creating subtitle files from files submitted to the Deepgram batch API. For an example of creating subtitle files with the Deepgram live streaming API, check out the [streaming test suite](https://github.com/deepgram/streaming-test-suite).
