...
Once you’ve selected your model, Deepgram provides many features and capabilities to help you transcribe and classify your audio. However, some capabilities and concepts are implemented differently from Google STT. Areas of difference are marked with an asterisk:

| Features and Capabilities          | Deepgram                                                                                                                                          | Google STT                    |
| ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------- |
| Base model                         | Yes                                                                                                                                               | Yes                           |
| Enhanced model                     | Yes - Phone Call and General                                                                                                                      | Yes - Phone Call and Video    |
| Batch processing (1hr of audio)\*  | 20 seconds                                                                                                                                        | 1443 seconds                  |
| Streaming processing lag           | 300 - 800 ms                                                                                                                                      | 800 - 2000 ms                 |
...
To see more, [visit Deepgram's Python SDK GitHub repo](https://github.com/deepgram/python-sdk).
