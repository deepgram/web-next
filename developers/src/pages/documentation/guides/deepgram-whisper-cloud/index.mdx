...
description: Learn how to get started with Deepgram's Whisper Cloud API.
type: "models"
order: 1
seo:
  metaTitle: Deepgram's Whisper Cloud
  metaDescription: Learn how to get started with Deepgram's Whisper Cloud API.
  keywords: whisper, speech-to-text, speech to text, asr, openai, model, LLM, deepgram
---
...
<Alert type="info">Deepgram owns and maintains these Whisper models; they aren't hosted or run by Open AI.</Alert>
...
If you would like to transcribe audio in a specific language, you can do so by setting the language parameter in the query string. This feature is limited to the languages supported among [these options](https://developers.deepgram.com/documentation/features/language/#language-options). To learn more about languages, see [Language](https://deploy-preview-710--romantic-gates-9c0b5e.netlify.app/documentation/features/language/).
