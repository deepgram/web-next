...
- have basic familiarity with Deepgram's API, specifically its [Transcribe Streaming Audio endpoint](/api-reference/transcription/#transcribe-live-streaming-audio).
