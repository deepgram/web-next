...
Once applied, you can identify tags associated with API requests returned by the [Get All Requests](/api-reference/#usage-all), [Get Request](/api-reference/#usage-get), and [Get Fields](/api-reference/#usage-fields) endpoints.

You can also directly query requests by tag at the [Summarize Usage](/api-reference/#usage-summary) endpoint.
