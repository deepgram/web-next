...
For self-serve customers, Deepgram provides Nova, Enhanced and Base models. To learn more about pricing, see [Deepgram Pricing & Plans](https://deepgram.com/pricing/). To learn about which models are available for which tiers, see [Models](/documentation/features/model/).
