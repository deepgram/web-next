...
For self-serve customers, Deepgram provides the following model tiers.
...
The Nova and Whisper models work differently than the Enhanced and Base models. For more information, see [Models](/documentation/features/model/).
  </Alert>
...
- `Whisper`: Deepgram's hosted version of OpenAI’s Whisper model. Whisper is a powerful speech-to-text model that is trained on a large corpus of text and audio data.
