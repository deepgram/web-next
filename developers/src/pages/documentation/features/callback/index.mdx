...
If the HTTP status code of the response to the callback POST request is not 200-299, Deepgram will retry the callback up to 10 times with a 30 second delay between attempts.
