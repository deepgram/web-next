...
- `whisper`: OpenAI's Whisper is an automatic speech recognition (ASR) system trained on 680,000 hours of multilingual and multitask supervised data collected from the web. [Try Whisper with Deepgram's API](https://deepgram.com/openai-whisper/), or learn more about Whisper in OpenAI's blog post, [Introducing Whisper](https://openai.com/blog/whisper/).
