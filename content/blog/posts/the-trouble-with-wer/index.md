...
description: Word error rate (WER) is one of the most common ways to evaluate
  automatic speech recognition. But is it the best choice?
date: 2019-01-03
...
The NATO phonetic alphabet was created to address the very same problem that causes WER to vary greatly for any one system: the variety of accents in language and the noisiness of communication methods make comprehension difficult. In 2018, top-performing call center representatives all know the NATO-PA because the [phone-POTS](https://sweet-pie-c52a63-blog.netlify.app/is-your-infrastructure-supporting-you-or-weighing-you-down/) and VoIP-are noisy, compressed communication media. ![Alt](https://res.cloudinary.com/deepgram/image/upload/v1661976790/blog/the-trouble-with-wer/nato-alphabet.png) 
