...
tags:
  ...
  - transcription
  - nodejs
cover: ./transcribe-meetings-in-real-time-use-case@2x.png
...
When connecting to the Deepgram server, you can configure options by appending query string parameters to the URL. To learn more about available options, read [API Reference: Deepgram API](/api-reference/#transcription-streaming).
