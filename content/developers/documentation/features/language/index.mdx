...
| **Dutch**                                    | `nl` *beta*      | `general`         | `enhanced`<br/>`base`  |
...
| **Flemish**                                  | `nl` *beta*      | `general`         | `enhanced`<br/>`base` |
...
| **Italian**                                  | `it` *beta*      | `general`         | `base` |
| **Japanese**                                 | `ja` *beta*      | `general`         | `base` |
| **Korean**                                   | `ko` *beta*      | `general`         | `base` |
| **Polish**                                   | `pl` *beta*      | `general`         | `base` |
| **Portuguese**                               | `pt`             | `general`         | `base` |
|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Brazil          | `pt-BR`          | `general`         | `base` |
|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Portugal        | `pt-PT`          | `general`         | `base` |
| **Russian**                                  | `ru`             | `general`         | `base` |
| **Spanish**                                  | `es`             | `general`         | `enhanced` *beta*<br/>`base` |
|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Latin America   | `es-419`         | `general`         | `base` |
| **Swedish**                                  | `sv` *beta*      | `general`         | `base` |
