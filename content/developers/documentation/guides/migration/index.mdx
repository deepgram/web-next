...
<div style="position: relative; padding-bottom: 62.5%; height: 0;"><iframe src="https://www.loom.com/embed/d71314d806384f208609772c17fd9cba" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;"></iframe></div>
...
1. Submit some test API calls to retrieve transcripts.
   ...
   **Fast:**
   ...
   For the [Transcribe Streaming Endpoint](/api-reference/transcription/#transcribe-live-streaming-audio), the [Interim Results](/api-reference/transcription/#interim_results-str) feature will be turned off by default. The streaming response will not return interim results unless your original request includes `interim_results=true`.
