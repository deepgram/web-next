...
2. For the **Choose an Amazon Machine Image (AMI)** wizard step, choose a basic configuration to serve as a template for your instance:
    ...
    <ol type="a">
    <li>Search for <strong>Ubuntu Server 20.04 LTS (HVM), SSD Volume Type</strong>.</li>
    <li>Ensure the <strong>64-bit (x86)</strong> option is selected.</li>
...
3. For the **Choose an Instance Type** wizard step, select the hardware configuration of your instance:
    ...
    <ol type="a">
    <li>Filter by the <code>g4dn</code> family type.</li>
    <li>Select the <strong>g4dn.2xlarge</strong> instance.</li>
    <li>Select <strong>Next: Configure Instance Details</strong>.</li>
    </ol>
...
6. For the **Add Tags** wizard step,  select “Add Tag”:
    ...
    <ol type="a">
    <li>For the key, type <code>Name</code>.</li>
     <li>For the value, type <code>On-Premises Base</code>  .</li>
     <li>Select <strong>Next: Configure Security Group</strong>.</li>
    </ol>
...
7. For the **Configure Security Group** wizard step, select **Create a new security group**.
    ...
    <ol type="a">
    <li>For the name, type <code>On-Premises</code>.</li>
    <li>For the description, type <code>On-Premises Base Security Group</code>.</li>
    <li>Ensure the first rule (of type <strong>SSH</strong>) is listed, and provide the description <code>SSH for Administration</code>.
...
1. Identify the latest driver for the GPU you are using and retrieve its download URL:
    ...
    <ol type="a">
    <li>Go to <a href="https://www.nvidia.com/download/index.aspx">NVIDIA Official Drivers</a>.</li>
    <li>Select the correct product and a corresponding CUDA toolkit 11 or greater.</li>
    <li>Select <strong>Search</strong> and check that the correct driver is displayed, then select <strong>Download</strong>.</li>
    <li>Right-click <strong>Agree & Download</strong>, then copy the link to save the download URL to your clipboard.</li>
    </ol>
