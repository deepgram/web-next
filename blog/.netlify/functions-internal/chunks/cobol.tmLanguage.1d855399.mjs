const _copyright = "The MIT License (MIT)\nCopyright (c) 2015-2022 spgennard\nSource: https://github.com/spgennard/vscode_cobol/blob/main/syntaxes/COBOL.tmLanguage.json";
const $schema = "https://raw.githubusercontent.com/spgennard/vscode_cobol/main/schemas/tmlanguage.json";
const fileTypes = [
	"ccp",
	"scbl",
	"cobol",
...
const scopeName = "source.cobol";
const cobol_tmLanguage = {
...
export { $schema, _copyright, cobol_tmLanguage as default, fileTypes, name, patterns, repository, scopeName };
