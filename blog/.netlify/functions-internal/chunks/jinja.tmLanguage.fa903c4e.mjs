const name = "jinja";
const scopeName = "source.jinja";
const comment = "Jinja Templates";
const foldingStartMarker = "({%\\s*(block|filter|for|if|macro|raw))";
const foldingStopMarker = "({%\\s*(endblock|endfilter|endfor|endif|endmacro|endraw)\\s*%})";
const patterns = [
	{
		begin: "({%)\\s*(raw)\\s*(%})",
		captures: {
...
export { comment, jinja_tmLanguage as default, foldingStartMarker, foldingStopMarker, name, patterns, repository, scopeName };
