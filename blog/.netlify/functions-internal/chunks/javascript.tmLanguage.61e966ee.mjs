...
const version = "https://github.com/microsoft/TypeScript-TmLanguage/commit/0dfae8cc4807fecfbf8f1add095d9817df824c95";
const name = "javascript";
const scopeName = "source.js";
const patterns = [
	{
		include: "#directives"
	},
...
export { javascript_tmLanguage as default, information_for_contributors, name, patterns, repository, scopeName, version };
