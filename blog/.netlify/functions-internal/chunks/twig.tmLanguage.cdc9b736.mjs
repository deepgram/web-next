...
const firstLineMatch = "<!(?i:DOCTYPE)|<(?i:html)|<\\?(?i:php)|\\{\\{|\\{%|\\{#";
...
const scopeName = "text.html.twig";
const uuid = "C220B028-86FF-44CB-8A59-27937FC83730";
const twig_tmLanguage = {
	fileTypes: fileTypes,
...
export { twig_tmLanguage as default, fileTypes, firstLineMatch, foldingStartMarker, foldingStopMarker, keyEquivalent, name, patterns, repository, scopeName, uuid };
