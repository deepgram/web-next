...
const version = "https://github.com/microsoft/vscode-mssql/commit/b8b58864526c048002b7c3964bdac8aac3713bd9";
const name = "sql";
const scopeName = "source.sql";
const patterns = [
	{
		match: "((?<!@)@)\\b(\\w+)\\b",
		name: "text.variable"
...
export { sql_tmLanguage as default, information_for_contributors, name, patterns, repository, scopeName, version };
