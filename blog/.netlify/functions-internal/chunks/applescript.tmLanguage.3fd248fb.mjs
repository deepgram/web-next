...
const firstLineMatch = "^#!.*(osascript)";
...
const scopeName = "source.applescript";
const uuid = "777CF925-14B9-428E-B07B-17FAAB8FA27E";
const applescript_tmLanguage = {
	fileTypes: fileTypes,
...
export { applescript_tmLanguage as default, fileTypes, firstLineMatch, keyEquivalent, name, patterns, repository, scopeName, uuid };
