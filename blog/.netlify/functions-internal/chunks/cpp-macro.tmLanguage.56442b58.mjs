...
const version = "https://github.com/jeff-hykin/better-cpp-syntax/commit/924295fc44bde1a00fab60da3a2caca4509adb25";
const name = "cpp-macro";
const scopeName = "source.cpp.embedded.macro";
const patterns = [
	{
...
export { cppMacro_tmLanguage as default, information_for_contributors, name, patterns, repository, scopeName, version };
