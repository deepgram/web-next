...
const version = "https://github.com/atom/language-php/commit/eb28b8aea1214dcbc732f3d9b9ed20c089c648bd";
const scopeName = "source.php";
const patterns = [
	{
		include: "#attribute"
	},
...
export { php_tmLanguage as default, information_for_contributors, name, patterns, repository, scopeName, version };
